<script lang="ts">
	...
	const parseColorTag = (html_tag: string) => {
		...
		if (tag.length > 2 && tag[1] == '-') {
			...
			switch (colorText) {
				case 'a': return "rgba(150, 50, 255)";
				case 'b': return "rgba(74, 82, 225)";
				case 'c': return "rgba(255, 255, 150)";
				case 'd': return "rgba(255, 150, 255)";
				case 'f': return "rgba(150, 255, 255)";
				case 'g': return "rgba(64, 227, 72)";
				case 'j': return "rgba(50, 200, 255)";
				case 'l': return "rgba(96, 171, 239)";
				case 'o': return "rgba(255, 165, 75)";
				case 'p': return "rgba(255, 0, 255)";
				case 'r': return "rgba(255, 90, 90)";
				case 's': return "rgba(255, 220, 65)";
				case 'y': return "rgba(255, 255, 0)";
			}
		}
	}
