...
<style lang="scss">
    ...
    div > :global(div) {
        ...
        &:nth-of-type(2) {
            animation: 7s ease-in-out 0.5s infinite alternate both running movey-img-2;
            z-index: 1;
        }
        &:nth-of-type(3) {
            animation: 6s ease-in-out 0.3s infinite alternate both running movey-img-3;
            opacity: 80%;
        }
    }
    @keyframes movey {
    ...
    @keyframes movey-2 {
        ...
        100% {
            transform: translateY(3em) rotate(-5deg) scale(85%);
        }
    }
    @keyframes movey-3 {
        0% {
            transform: translateY(-1em) rotate(-105deg) scale(70%);
        }
        50% {
            transform: rotate(-70deg);
        }
        100% {
            transform: translate(1em, 2em) rotate(-5deg) scale(85%);
        }
    }
    @keyframes movey-img-1 {
        ...
        100% {
            transform: translateX(0.25em) translateY(0.25em) rotate(-25deg) scale(70%);
        }
    }
