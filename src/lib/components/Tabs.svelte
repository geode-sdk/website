...
<script lang="ts">
    ...
    const unsuscribe = tabs.subscribe(
        (t) => ($selectedTab = t.length ? t[0].id : ""),
    );
    ...
    .tabs {
        ...
        button {
            ...
            border: 0.15rem solid
                color-mix(in srgb, var(--background-300) 50%, transparent);
            // border: none;
