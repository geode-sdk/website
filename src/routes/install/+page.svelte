...
<svelte:head>
    ...
    <meta
        name="description"
        content="Install Geode on Windows, Android and MacOS"
    />
</svelte:head>
...
<Column>
    ...
    <section class="hidden">
        <InfoBox type="warning">
            Geode is not yet out for Geometry Dash 2.206! Geode will be released
            for 2.206 on June 22nd at 9 PM Swedish time.
            <br /><br />
            You can join <Link
                --link-color="var(--accent-300)"
                href="https://youtu.be/RKwBBcHk6OA"
                >the Premiere of our announcement video</Link
    ...
    <section>
        <Column>
            ...
            <span style="color: var(--background-300)">
                <Column align="left">
                    <Row>
                        <Icon icon="one" />
                        <p>
                            Download the <em>installer</em> for the platform you
                            want.
                        </p>
                    </Row>
                    <Row>
            ...
            <p>
                Geode is available for <em>Windows</em>, <em>MacOS</em>,
                <em>Linux</em>
                (through <em>Wine / Proton</em>) and <em>Android</em>.
            </p>
        </Column>
    </section>
    <section>
        <Column>
            ...
            {#if curPlatform === "unknown"}
                <p>
                    Couldn't auto detect your platform. You can download Geode
                    for your chosen platform below.
                </p>
            {/if}
            {#if curPlatform === "linux"}
                <p>
                    Geometry Dash is not available on <em>Linux</em>, but you
                    can run the <em>Windows</em> version through
                    <em>Wine / Proton</em>. <Link
                        href="faq#i-am-installing-geode-on-linux-what-do-i-have-to-do"
                        >Click here for more info.</Link
                    >
                </p>
                <Button
                    style="primary-filled"
                    href={createVersionString("windows")}
                >
            ...
            {#if !showAllPlatforms}
                ...
                {#if curPlatform == "android"}
                    <Button
                        style="primary-filled"
                        href={createVersionString("android")}
                    >
...
<FlyIntoView>
    <div class="img-with-width">
        <Image
            name="main-menu"
            alt="The main menu, showing the Geode button"
            style="shadow"
        />
    </div>
    <Column align="left">
        <p>
            Once you have <em>installed Geode</em>, you should see a new button
            in the bottom row of the main menu.
            <br />
            <br />
...
<FlyIntoView>
    ...
    <Column align="left">
        <p>
            The first page you see is the <em
                >list of mods you currently have installed</em
            >. Use the toggles to quickly <em>enable/disable</em> any mods, or
            click <em>View</em> for further options like editing mod settings and
            uninstalling.
        </p>
        <Row wrap="wrap">
...
<FlyIntoView>
    <div class="img-with-width">
        <Image
            name="download-page"
            alt="The download tab of the Geode menu"
            style="shadow"
        />
    </div>
    <Column align="left">
        <p>
            The other pages - <em>Recommended</em>, <em>Download</em>, and
            <em>Trending</em>
            are dedicated to finding new mods.
            <br />
            <br />
            You can use the <em>search button</em> on the left to search for
            specific mods by name or by <em>tags</em>.
        </p>
        <Row wrap="wrap">
            <Button style="hollow">
